...
STORE 'Kecepatan' with 20
STORE 'penumpang' with 3

IF 'penumpang' more than 2 AND LESS than 4 then
	CALCULATE 'kecepatan' decrease by 5
ELSE IF 'penumpang' equals to 4 then
	CALCULATE 'kecepatan' decrease by 7
ELSE
	CALCULATE 'kecepatan' decrease by 2
END IF

DISPLAY 'Kecepatan becak sekarang dengan penumpang'+penumpang+' = '+'kecepatan'
